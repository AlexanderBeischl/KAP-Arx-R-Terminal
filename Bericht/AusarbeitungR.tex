...
Das Datenanonymisierungstool \textit{ARX}, welches am Institut für Medizinische Statistik und Epidemiologie entwickelt wurde, implementiert verschiedene Methoden der Datenanonymisierung. Allerdings kommt es bei jeder Anonymisierung zu einem Informationsverlust und Verzerrungen der statistischen Eigenschaften. 
Vor dem Austausch anonymisierter Daten müssen diese also geprüft werden, beispielsweise indem die Eingabedaten mit den anonymisierten Ausgabedaten verglichen werden. Um dabei die Auswirkungen der Anonymisierung auf eine Vielzahl statistischer Eigenschaften und Verfahren analysieren zu können, bietet sich die Nutzung eines Statistikprogramms an.
...
Im Kapitel "`Benutzung von R für ARX"' werden Möglichkeiten für den Import von Tabellen aus \textit{ARX} in \textit{R} vorgestellt, welche allerdings noch nicht implementiert wurden.
