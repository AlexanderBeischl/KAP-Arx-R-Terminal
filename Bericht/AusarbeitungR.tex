...
\begin{itemize}
	...
	\item ein Listener der Klasse \textit{RListener}
\end{itemize}
...
In diesem Unterkapitel werden mögliche Alternativen vorgestellt um \textit{R} in ein \textit{Java}-Programm zu integrieren.
